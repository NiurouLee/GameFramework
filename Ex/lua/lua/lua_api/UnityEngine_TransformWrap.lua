...
---@overload fun(path:DG.Tweening.Plugins.Core.PathCore.Path, duration:float, pathMode:DG.Tweening.PathMode):DG.Tweening.Core.TweenerCore
---@param path table
---@param duration float
...
---@param elasticity float
---@return DG.Tweening.Tweener
function m:DOBlendablePunchRotation(punch, duration, vibrato, elasticity) end
---@param byValue UnityEngine.Vector3
---@param duration float
---@return DG.Tweening.Tweener
