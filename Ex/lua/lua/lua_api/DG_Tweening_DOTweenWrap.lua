...
---@param fillableList table
---@return table
function m.PlayingTweens(fillableList) end
---@param fillableList table
---@return table
function m.PausedTweens(fillableList) end
---@param id object
---@param playingOnly bool
---@param fillableList table
---@return table
function m.TweensById(id, playingOnly, fillableList) end
---@param target object
---@param playingOnly bool
---@param fillableList table
---@return table
function m.TweensByTarget(target, playingOnly, fillableList) end
DG = {}
DG.Tweening = {}
