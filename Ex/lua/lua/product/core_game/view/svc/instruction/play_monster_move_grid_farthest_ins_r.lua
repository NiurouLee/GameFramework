...
---@class PlayMonsterMoveGridFarthestInstruction: BaseInstruction
_class("PlayMonsterMoveGridFarthestInstruction", BaseInstruction)
PlayMonsterMoveGridFarthestInstruction = PlayMonsterMoveGridFarthestInstruction

---@param casterEntity Entity
---@param phaseContext SkillPhaseContext
function PlayMonsterMoveGridFarthestInstruction:DoInstruction(TT, casterEntity, phaseContext)
    ---@type SkillEffectResultContainer
    local skillEffectResultContainer = casterEntity:SkillRoutine():GetResultContainer()
    ---@type SkillEffectMonsterMoveGridToSkillRangeFarResult[]
    local results = skillEffectResultContainer:GetEffectResultsAsArray(SkillEffectType.MonsterMoveGridFarthest)
...
function PlayMonsterMoveGridFarthestInstruction:_ShowLinkLine(TT,walkResultList,element)
...
function PlayMonsterMoveGridFarthestInstruction:_DestroyLinkLine(moveInPos)
...
function PlayMonsterMoveGridFarthestInstruction:_DoWalk(TT, monsterEntity, walkResultList, casterIsDead)
    ---@type BoardServiceRender
    local boardServiceRender = self._world:GetService("BoardRender")
...
function PlayMonsterMoveGridFarthestInstruction:_PlayArrivePos(TT, monsterEntity, walkRes)
    ---触发机关的表现
...
---@param casterEntity Entity
function PlayMonsterMoveGridFarthestInstruction:_GetMoveSpeed(casterEntity)
    ---@type ConfigService
...
function PlayMonsterMoveGridFarthestInstruction:StartMoveAnimation(targetEntity, isMove)
