...
---@class PlaySelectedSplashDamageInstruction: BaseInstruction
_class("PlaySelectedSplashDamageInstruction", BaseInstruction)
PlaySelectedSplashDamageInstruction = PlaySelectedSplashDamageInstruction

function PlaySelectedSplashDamageInstruction:Constructor(paramList)
...
function PlaySelectedSplashDamageInstruction:GetCacheResource()
    local t = {}
...
function PlaySelectedSplashDamageInstruction:DoInstruction(TT, casterEntity, phaseContext)
    ...
    local results = skillEffectResultContainer:GetEffectResultsAsArray(SkillEffectType.SplashDamage, stageIndex)
    ...
    local index = phaseContext:GetCurResultIndexByType(SkillEffectType.SplashDamage)
