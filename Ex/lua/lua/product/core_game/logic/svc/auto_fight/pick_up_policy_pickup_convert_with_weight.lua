...
---@class PickUpPolicy_PickUpConvertWithWeight: PickUpPolicy_Base
...
function PickUpPolicy_PickUpConvertWithWeight:_CalcSinglePickResult(calcParam, overwritePosList)
    ...
    ---@type PickUpPolicy_PickUpConvertWithWeight_CandidateInfo[]
    ...
    if #weightedCandidates > 0 then
        ...
        ---@type table<number, PickUpPolicy_PickUpConvertWithWeight_LinkLineGroup[]>
        ...
        for gridIndex, groups in pairs(surroundingGridsGroupByIndex) do
            ...
            if self:_IsSuitableCandidate(v2, policyParam) and (not table.Vector2Include(overwritePosList, v2)) then
                ---@type PickUpPolicy_PickUpConvertWithWeight_LinkLineGroup
...
---@class PickUpPolicy_PickUpConvertWithWeight_CandidateInfo
---@field pos Vector2
---@field weight number
---@field sortIndex number

---@param calcParam PickUpPolicy_CalcParam
---@return PickUpPolicy_PickUpConvertWithWeight_CandidateInfo[]
...
---@class PickUpPolicy_PickUpConvertWithWeight_LinkLineGroup : Object
...
---@param group PickUpPolicy_PickUpConvertWithWeight_LinkLineGroup
...
---@param a PickUpPolicy_PickUpConvertWithWeight_LinkLineGroup
---@param b PickUpPolicy_PickUpConvertWithWeight_LinkLineGroup
...
---@return PickUpPolicy_PickUpConvertWithWeight_LinkLineGroup[]
