...
function SkillEffectCalcService:RegistSkillEffectCalculator()
    ...
    self._skillEffectCalculatorDic[SkillEffectType.ConvertOccupiedGridElement] =
        SkillEffectCalc_ConvertOccupiedGridElement
    ...
    self._skillEffectCalculatorDic[SkillEffectType.ResetSingleColorGridElement] =
        SkillEffectCalcResetSingleColorGridElement
    ...
    self._skillEffectCalculatorDic[SkillEffectType.DamageBasedOnTargetAttribute] =
        SkillEffectCalc_DamageBasedOnTargetAttribute
    ...
    self._skillEffectCalculatorDic[SkillEffectType.MultipleScopesDealMultipleDamage] =
        SkillEffectCalc_MultipleScopesDealMultipleDamage
    ...
    self._skillEffectCalculatorDic[SkillEffectType.FrontExtendDegressiveDamage] =
        SkillEffectCalc_FrontExtendDegressiveDamage
    self._skillEffectCalculatorDic[SkillEffectType.TeleportAndSummonTrap] = SkillEffectCalc_TeleportAndSummonTrap
    -- self._skillEffectCalculatorDic[SkillEffectType.DegressiveDirectionalDamage] = SkillEffectParam_DegressiveDirectionalDamage
    ...
    self._skillEffectCalculatorDic[SkillEffectType.MultipleDamageWithBuffLayer] =
        SkillEffectCalc_MultipleDamageWithBuffLayer
    ...
    --self._skillEffectCalculatorDic[SkillEffectType.DamageReflectDistance] = SkillEffectCalc_DamageReflectDistance
    ...
    self._skillEffectCalculatorDic[SkillEffectType.AddBloodOverFlowForDamage] =
        SkillEffectCalc_AddBloodOverFlowForDamage
    ...
    self._skillEffectCalculatorDic[SkillEffectType.AbsorbTrapsAndDamageByPickupTarget] =
        SkillEffectCalc_AbsorbTrapsAndDamageByPickupTarget
    self._skillEffectCalculatorDic[SkillEffectType.MoveBoard] = SkillEffectCalc_MoveBoard
    self._skillEffectCalculatorDic[SkillEffectType.MonsterMoveGridByMonsterElement] =
        SkillEffectCalc_MonsterMoveGridByElement
