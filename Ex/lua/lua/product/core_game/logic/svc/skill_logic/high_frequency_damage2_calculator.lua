...
---@class HighFrequencyDamage2Calculator:Object
...
---@param effectParam SkillEffectParam_HighFrequencyDamage2
...
--计算额外攻击次数
---@param param SkillEffectParam_HighFrequencyDamage2
...
function HighFrequencyDamage2Calculator:_CalExtraAttackCount(param, attacker)
    ...
    local scopeResult =
    scopeCalculator:ComputeScopeRange(serialScopeType, serialScopeParam,centerPos, casterBodyArea,
            attacker:GetGridDirection(),nil,posCaster,attacker)
    ---@type BoardComponent
