---@class UISetAutoFightCount:UIController
_class("UISetAutoFightCount", UIController)
UISetAutoFightCount = UISetAutoFightCount

function UISetAutoFightCount:OnShow(uiParams)
...
function UISetAutoFightCount:closeOnClick()
    self:CloseDialog()
end

function UISetAutoFightCount:btnGoOnClick()
    --体力不够打开恢复棱镜界面
    if self._powerNotEnough then
...
function UISetAutoFightCount:addBtnOnClick()
...
function UISetAutoFightCount:subBtnOnClick()
...
function UISetAutoFightCount:Apply()
...
function UISetAutoFightCount:ChangePhysicalPowerNumber(num)
    self:Apply()
end

function UISetAutoFightCount:GetMatchType()
    return self._matchType
end

function UISetAutoFightCount:GetNeedPower()
    return self._needPower
end

function UISetAutoFightCount:GetDoubleTicket()
    return self._doubleTicket
end

function UISetAutoFightCount:GetUuid()
    return self._uuid
end

function UISetAutoFightCount:ChkAutoPick()
