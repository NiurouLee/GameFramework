---@class UIN15LineMissionMapNodeReview : UICustomWidget
_class("UIN15LineMissionMapNodeReview", UICustomWidget)
UIN15LineMissionMapNodeReview = UIN15LineMissionMapNodeReview

function UIN15LineMissionMapNodeReview:OnShow(uiParams)
    self:InitWidget()
end

function UIN15LineMissionMapNodeReview:InitWidget()
    --generated--
...
function UIN15LineMissionMapNodeReview:SetData(lineCfg, passInfo, cb)
    ...
    if lineCfg.WayPointType == 4 then
        --S关
        typeCfg = UIN15LineMissionControllerReview.NodeCfg[UIN15LineMissionControllerReview.SLeval]
    else
        --战斗、剧情、boss
        typeCfg = UIN15LineMissionControllerReview.NodeCfg[missionCfg.Type]
    end
    local bg = nil
...
function UIN15LineMissionMapNodeReview:_SetRed(isShow)
    local redObj = self:GetGameObject("red")
    redObj:SetActive(isShow)
end

function UIN15LineMissionMapNodeReview:BtnOnClick(go)
