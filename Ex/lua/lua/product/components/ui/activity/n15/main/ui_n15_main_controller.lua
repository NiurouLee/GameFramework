---@class UIN15MainController : UIController
...
function UIN15MainController:LoginAwardBtnOnClick(go)
    ...
    self:ShowDialog(
        ...
        true,
        ECampaignType.CAMPAIGN_TYPE_N15,
        ECampaignN15ComponentID.ECAMPAIGN_N15_CUMULATIVE_LOGIN
    )
end
...
function UIN15MainController:ChessBtnOnClick(go)
    ...
    -- if not self._componentState[999] then
    --     ToastManager.ShowToast(StringTable.Get("str_n15_over_activity"))
    --     self:SwitchState(UIStateType.UIMain)
    --     return
    -- end
