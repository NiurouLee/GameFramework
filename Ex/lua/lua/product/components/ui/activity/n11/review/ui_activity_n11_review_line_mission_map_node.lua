---@class UIActivityN11ReviewLineMissionMapNode : UICustomWidget
_class("UIActivityN11ReviewLineMissionMapNode", UICustomWidget)
UIActivityN11ReviewLineMissionMapNode = UIActivityN11ReviewLineMissionMapNode

function UIActivityN11ReviewLineMissionMapNode:OnShow(uiParams)
    self:InitWidget()
...
function UIActivityN11ReviewLineMissionMapNode:InitWidget()
    --generated--
...
function UIActivityN11ReviewLineMissionMapNode:SetData(lineCfg, passInfo, cb)
    ...
    if lineCfg.WayPointType == 4 then
        --S关
        typeCfg = UIActivityN11LineMissionController_Review.NodeCfg[UIActivityN11LineMissionController_Review.SLeval]
    else
        --战斗、剧情、boss
        typeCfg = UIActivityN11LineMissionController_Review.NodeCfg[missionCfg.Type]
    end
    local bg = nil
...
function UIActivityN11ReviewLineMissionMapNode:_SetRed(isShow)
    local redObj = self:GetGameObject("red")
    redObj:SetActive(isShow)
end

function UIActivityN11ReviewLineMissionMapNode:BtnOnClick(go)
