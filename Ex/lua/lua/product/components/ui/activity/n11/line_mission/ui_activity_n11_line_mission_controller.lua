---@class UIActivityN11LineMissionController:UIController
...
function UIActivityN11LineMissionController:OnShow(uiParams)
    ...
    UIActivityN11LineMissionController.SLeval = 111111 --s关枚举id
    UIActivityN11LineMissionController.Passed = 888 --通关后文本和阴影颜色
