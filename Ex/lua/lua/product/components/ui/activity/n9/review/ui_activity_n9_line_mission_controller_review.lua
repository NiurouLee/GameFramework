---@class UIActivityN9LineMissionController_Review:UIController
    ...
    self._backBtns:SetData(
        function()
            ...
            campaignModule:CampaignSwitchState(
                true,
                UIStateType.UIActivityN9MainController_Review,
                UIStateType.UIMain,
                nil,
                self._campaign._id
            )
...
function UIActivityN9LineMissionController_Review:OnShow(uiParams)
    ...
    UIActivityN9LineMissionController_Review.Passed = 888 --通关后文本和阴影颜色
