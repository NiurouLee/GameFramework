---@class UICampaignShopItemSmall : UICustomWidget
_class("UICampaignShopItemSmall", UICustomWidget)
UICampaignShopItemSmall = UICampaignShopItemSmall
function UICampaignShopItemSmall:OnShow(uiParams)
    self:InitWidget()
end
function UICampaignShopItemSmall:InitWidget()
    --generated--
...
function UICampaignShopItemSmall:OnHide()
    self:DetachEvent(GameEventType.ActivityShopBuySuccess, self._ActivityShopBuySuccess)
end
function UICampaignShopItemSmall:SetData()
end
function UICampaignShopItemSmall:InfoAreaOnClick(go)
...
function UICampaignShopItemSmall:InitData(data)
    self._data = data
    self:_fillPriceArea()
...
function UICampaignShopItemSmall:_fillPriceArea()
...
function UICampaignShopItemSmall:_fillItemBaseArea()
    local icon = ""
...
function UICampaignShopItemSmall:_fillItemCountArea()
...
function UICampaignShopItemSmall:_FillRemainArea()
...
function UICampaignShopItemSmall:_ActivityShopBuySuccess(goodsId)
...
function UICampaignShopItemSmall:GetInfoBg()
    return self._infoBg
end