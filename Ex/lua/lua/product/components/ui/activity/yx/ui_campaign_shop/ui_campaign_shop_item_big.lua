---@class UICampaignShopItemBig : UICustomWidget
_class("UICampaignShopItemBig", UICustomWidget)
UICampaignShopItemBig = UICampaignShopItemBig
function UICampaignShopItemBig:OnShow(uiParams)
    self:InitWidget()
end
function UICampaignShopItemBig:InitWidget()
    --generated--
...
function UICampaignShopItemBig:OnHide()
    self:DetachEvent(GameEventType.ActivityShopBuySuccess, self._ActivityShopBuySuccess)
end
function UICampaignShopItemBig:SetData()
end
function UICampaignShopItemBig:InfoAreaOnClick(go)
...
function UICampaignShopItemBig:InitData(data)
    self._data = data
    self:_fillPriceArea()
...
function UICampaignShopItemBig:_fillPriceArea()
...
function UICampaignShopItemBig:_fillItemBaseArea()
    local icon = ""
...
function UICampaignShopItemBig:_fillItemCountArea()
...
function UICampaignShopItemBig:_FillRemainArea()
...
function UICampaignShopItemBig:_ActivityShopBuySuccess(goodsId)
...
function UICampaignShopItemBig:GetInfoBg()
    return self._infoBg
end