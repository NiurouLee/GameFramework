---@class UIXH1MissionLine:UICustomWidget
_class("UIXH1MissionLine", UICustomWidget)
UIXH1MissionLine = UIXH1MissionLine

function UIXH1MissionLine:OnShow()
...
function UIXH1MissionLine:OnHide()
...
function UIXH1MissionLine:Flush(sNode, eNode, isShadow)
...
function UIXH1MissionLine:FlushState(nodeId)
...
function UIXH1MissionLine:Animation()
