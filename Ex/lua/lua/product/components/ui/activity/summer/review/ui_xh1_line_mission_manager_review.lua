---@class UIXH1LineMissionManagerReview:Object
_class("UIXH1LineMissionManagerReview", Object)
UIXH1LineMissionManagerReview = UIXH1LineMissionManagerReview

function UIXH1LineMissionManagerReview:Constructor()
    --- @type MissionModule
...
function UIXH1LineMissionManagerReview:GetNodes()
    return self.nodes
end

---@return table<UIActivityMissionNodeInfo, UIActivityMissionNodeInfo>
function UIXH1LineMissionManagerReview:GetLines()
    return self.lines
end

function UIXH1LineMissionManagerReview:GetTotalWidth()
    return self.totalWidth
end

function UIXH1LineMissionManagerReview:GetScrollPos(missionId)
...
function UIXH1LineMissionManagerReview:GetLineExtraConfig()
    return self._lineExtraCfg
end

function UIXH1LineMissionManagerReview:Init(componentInfo, componentId)
...
function UIXH1LineMissionManagerReview:Update()
...
function UIXH1LineMissionManagerReview:_MakeLineExtraConfig(componentId)
    local newConfig = {}
...
function UIXH1LineMissionManagerReview:_MakeLineConfig(componentId)
    local newConfig = {}
...
function UIXH1LineMissionManagerReview:_MakeUnlockConfig(lineMission)
    local newConfig = {}
...
function UIXH1LineMissionManagerReview:_UpdateMissionState(unlockMission)
...
function UIXH1LineMissionManagerReview:_UpdateNodePos(lineMission, missionState)
    local minPosX = nil
    local maxPosX = nil
...
function UIXH1LineMissionManagerReview:_FillData_Nodes(lineMission, missionState)
    local newConfig = {}
...
function UIXH1LineMissionManagerReview:_FillData_Lines(campaignMission, unlockMission)
    local newConfig = {}
    for k, v in pairs(unlockMission) do
...
function UIXH1LineMissionManagerReview:GetScrollSpliter()
    -- local ids = {}
