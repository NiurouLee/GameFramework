---@class UIActivityN5SimpleLevel:UIController
...
function UIActivityN5SimpleLevel:OnShow(uiParams)
    ...
    self._scroller =
        UIActivityN5Scroller:New(self._contentRect, bgLoader1, bgLoader2,_bgNames,self._lineMissionManager:GetScrollSpliterVec())
...
function UIActivityN5SimpleLevel:_GetComponents()
    ...
    --self._transition = self:GetUIComponent("ATransitionComponent", "UIActivityN5SimpleLevel")
    --self._anim = self:GetUIComponent("Animation", "UIActivityN5SimpleLevel")
