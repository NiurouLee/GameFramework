---@class UIActivityN22LineMissionController:UIController
...
function UIActivityN22LineMissionController:OnShow(uiParams)
    ...
    UIActivityN22LineMissionController.SLeval = 111111 --s关枚举id
    UIActivityN22LineMissionController.Passed = 888 --通关后文本和阴影颜色
    UIActivityN22LineMissionController.NodeCfg = {
        [DiscoveryStageType.FightNormal] = {
            [1] = {
                ...
                press = "",
                lock = "",
                textColor = Color(124 / 255, 87 / 255, 60 / 255), -- 不使用
        ...
        [DiscoveryStageType.FightBoss] = {
            [1] = {
                ...
                press = "",
                lock = "",
                textColor = Color.New(149 / 255, 22 / 255, 19 / 255), -- 不使用
        ...
        [DiscoveryStageType.Plot] = {
            [1] = {
                ...
                lock = "",
                textColor = Color.New(72 / 255, 41 / 255, 41 / 255), -- 不使用
...
function UIActivityN22LineMissionController:FlushNodes()
    ...
    ---@type table<number,UIActivityN22LineMissionMapLine>
    local lines = self._linesPool:GetAllSpawnList()

    local nodeIdx, lineIdx = 1, 1
    for missionID, cfg in pairs(showMission) do
        ---@type UIActivityN22LineMissionMapNode
        ...
        if cfg.WayPointType ~= 4 and cfg.NeedMissionId ~= 0 then
            ...
            local n2 = cfg
            ---@type UIActivityN22LineMissionMapLine
