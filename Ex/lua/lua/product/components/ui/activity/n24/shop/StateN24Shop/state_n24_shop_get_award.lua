---@class StateN24ShopGetAward : StateN24ShopBase
    ...
    local cbFunc = function()
        if isOpenNew then --开启新奖池
            ...
            PopupManager.Alert(
                ...
                PopupMsgBoxType.Ok,
                StringTable.Get("str_n24_shop_new_box_unlock_title"),
                StringTable.Get("str_n24_shop_open_next_text", curPageIndex, curPageIndex + 1),
                function()
            ...
            if hasBig and self.data:GotAllBigAward() then
                PopupManager.Alert(
                    ...
                    PopupMsgBoxType.Ok,
                    "",
                    StringTable.Get("str_n24_shop_loop_box_reset_tips"), --已获得全部特殊奖励
                    function()
                        self:ForceRefresh(true)
                    end,
                    nil
