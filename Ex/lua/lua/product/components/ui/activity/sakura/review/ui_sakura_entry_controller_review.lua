---@class UISakuraEntryController_Review : UIController
...
function UISakuraEntryController_Review:LoadDataOnEnter(TT, res, uiParams)
    ...
    --     TT,
    --     res,
    --     ECampaignType.CAMPAIGN_TYPE_REVIEW_N2,
    --     ECampaignHiiroComponentID.ECAMPAIGN_REVIEW_HIIRO_STORY,
...
function UISakuraEntryController_Review:_GetComponents()
    ...
    self._btnImg = {}
    self._btnImg[ECampaignReviewHiiroComponentID.ECAMPAIGN_REVIEW_HIIRO_STORY] =
        self:GetUIComponent("RawImageLoader", "SakuraBtn")
    ...
    self._btnText = {}
    self._btnText[ECampaignReviewHiiroComponentID.ECAMPAIGN_REVIEW_HIIRO_STORY] =
...
-- function UISakuraEntryController_Review:_OnItemCountChanged()
--     self:_RefreshCampaignItemCount()
-- end
-- function UISakuraEntryController_Review:_RefreshCampaignItemCount()
...
-- function UISakuraEntryController_Review:TaskBtnOnClick(go)
--     AudioHelperController.PlayUISoundAutoRelease(CriAudioIDConst.SakuraCommonClick)
--     self:_ShowChildUI(
--         ECampaignHiiroComponentID.ECAMPAIGN_HIIRO_QUEST,
...
--     )
-- end
-- function UISakuraEntryController_Review:ShopBtnOnClick(go)
--     AudioHelperController.PlayUISoundAutoRelease(CriAudioIDConst.SakuraCommonClick)
--     self:_ShowChildUI(ECampaignHiiroComponentID.ECAMPAIGN_HIIRO_LOTTERY, "UISakuraDrawShopController")
-- end
-- function UISakuraEntryController_Review:LoginAwardBtnOnClick(go)
--     AudioHelperController.PlayUISoundAutoRelease(CriAudioIDConst.SakuraCommonClick)
--     self:_ShowChildUI(
--         ECampaignHiiroComponentID.ECAMPAIGN_HIIRO_CUMULATIVE_LOGIN,
...
function UISakuraEntryController_Review:_RefreshComponentState()
    self._componentState[ECampaignReviewHiiroComponentID.ECAMPAIGN_REVIEW_HIIRO_STORY] =
        self:_GetComponentState(ECampaignReviewHiiroComponentID.ECAMPAIGN_REVIEW_HIIRO_STORY)
