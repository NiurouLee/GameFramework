---@class UIN19HardLevelController : UIController
...
function UIN19HardLevelController:LoadDataOnEnter(TT, res)
    ...
    self._campaign:LoadCampaignInfo(
        TT,
        res,
        ECampaignType.CAMPAIGN_TYPE_N19_COMMON,
...
function UIN19HardLevelController:_FadeInAnim()
    self:_RefreshPoint()
    self._fadeInTimer = GameGlobal.Timer():AddEvent(
        650,
        function()
...
function UIN19HardLevelController:InitWidget()
    ...
    ---@type table<number,UIN19HardLevelItem>
    self._levels = {}
    for i = 1, 6 do
