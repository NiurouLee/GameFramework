---@class UIN7LevelLine:UICustomWidget
_class("UIN7LevelLine", UICustomWidget)
UIN7LevelLine = UIN7LevelLine

function UIN7LevelLine:OnShow()
    ---@type UnityEngine.RectTransform
    self._rect = self:GetUIComponent("RectTransform", "shape")
end

function UIN7LevelLine:OnHide()
end

function UIN7LevelLine:Flush(from, to)
