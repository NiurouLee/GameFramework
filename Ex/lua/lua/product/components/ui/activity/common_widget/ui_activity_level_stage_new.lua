...
---@class UIActivityLevelStageNew:UIController
...
function UIActivityLevelStageNew:OnShow(uiParams)
    ...
    self._hideTopMenu = uiParams[6] or false --隐藏顶条
    self._hideCost = uiParams[7] or false --隐藏挑战按钮上的体力图标
    self._useBgName = uiParams[8] or false --换背景图
    self._useNewTitle = uiParams[9] or false --换标题prefab
    self._isChess = uiParams[10] or false --是否是战旗关卡
...
function UIActivityLevelStageNew:Init()
    ...
    self._enemyObj:Flush(
        ...
        enemyTitleBgSprite,
        enemyTitleBg2Sprite,
        self._isChess or self._showAwakenTips,
        true
    )
...
--region UIActivityLevelStageNew 剧情回顾
