---@class UIActivityN8LineMissionController:UIController
...
function UIActivityN8LineMissionController:OnShow(uiParams)
    ...
    UIActivityN8LineMissionController.SLeval = 999 --s关枚举id
    UIActivityN8LineMissionController.Passed = 888 --通关后文本和阴影颜色
...
function UIActivityN8LineMissionController:FlushNodes()
    ...
    for missionID, cfg in pairs(showMission) do
        ---@type UIActivityN8LineMissionMapNode
