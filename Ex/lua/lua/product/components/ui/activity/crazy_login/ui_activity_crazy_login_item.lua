---@class UIActivityCrazyLoginItem : UICustomWidget
_class("UIActivityCrazyLoginItem", UICustomWidget)
UIActivityCrazyLoginItem = UIActivityCrazyLoginItem

function UIActivityCrazyLoginItem:OnShow(uiParams)
    self:InitWidget()
end

function UIActivityCrazyLoginItem:InitWidget()
    ---@type RawImageLoader
...
function UIActivityCrazyLoginItem:SetData(data, callback)
...
function UIActivityCrazyLoginItem:_SetAlpha(alpha)
...
function UIActivityCrazyLoginItem:IconOnClick(go)
