---@class UINP6LevelNode : UICustomWidget
_class("UINP6LevelNode", UICustomWidget)
UINP6LevelNode = UINP6LevelNode
function UINP6LevelNode:OnShow(uiParams)
    self:InitWidget()
end
function UINP6LevelNode:InitWidget()
    --generated--
...
function UINP6LevelNode:SetData(lineCfg, passInfo, cb)
    ...
    if lineCfg.WayPointType == 4 then
        --S关
        typeCfg = UINP6Level.NodeCfg[UINP6Level.SLeval]
    else
        --战斗、剧情、boss
        typeCfg = UINP6Level.NodeCfg[missionCfg.Type]
    end
...
function UINP6LevelNode:btnOnClick(go)
