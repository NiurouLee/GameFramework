---@class UIN29ChessMapLine:UICustomWidget
_class("UIN29ChessMapLine", UICustomWidget)
UIN29ChessMapLine = UIN29ChessMapLine

-- OnShow
function UIN29ChessMapLine:OnShow()
    ---@type UnityEngine.RectTransform
    self._lineRect = self:GetUIComponent("RectTransform", "UIN29ChessMapLine")
    ---@type UnityEngine.RectTransform
    self._rect = self:GetUIComponent("RectTransform", "shape")
end

-- 刷新
function UIN29ChessMapLine:Flush(from, to)
