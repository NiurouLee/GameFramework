---@class UIN21LineMissionConst:UIController
_class("UIN21LineMissionConst", UIController)
UIN21LineMissionConst = UIN21LineMissionConst

-- s关枚举id
function UIN21LineMissionConst.SLevel()
    return 999
end

--通关后文本和阴影颜色
function UIN21LineMissionConst.Passed()
    return 888
end

function UIN21LineMissionConst.NodeCfg()
    return {
