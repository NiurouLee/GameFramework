...
---@class UIWorldBossMultiToolFunctions
local UIWorldBossMultiToolFunctions =
{
    --获取剩余时间
...
_enum("UIWorldBossMultiToolFunctions", UIWorldBossMultiToolFunctions)

---@class UIWorldBossMultiKey
local UIWorldBossMultiKey =
{
    Opened = "Opened",
}
_enum("UIWorldBossMultiKey", UIWorldBossMultiKey)
