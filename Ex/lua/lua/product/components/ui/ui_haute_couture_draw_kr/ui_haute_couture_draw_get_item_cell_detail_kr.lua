--
---@class UIHauteCoutureDrawGetItemCellDetailKR : UICustomWidget
_class("UIHauteCoutureDrawGetItemCellDetailKR", UICustomWidget)
UIHauteCoutureDrawGetItemCellDetailKR = UIHauteCoutureDrawGetItemCellDetailKR
--初始化
function UIHauteCoutureDrawGetItemCellDetailKR:OnShow(uiParams)
    self:InitWidget()
end
--获取ui组件
function UIHauteCoutureDrawGetItemCellDetailKR:InitWidget()
    --generated--
    ---@type UICustomWidgetPool
    local item = self:GetUIComponent("UISelectObjectPath", "item")
    ---@type UIHauteCoutureDrawGetItemCellKR
    self.item = item:SpawnObject("UIHauteCoutureDrawGetItemCellKR")
...
--设置数据
function UIHauteCoutureDrawGetItemCellDetailKR:SetData(itemInfo)
