--贡露时装奖励item
---@class UIHauteCoutureDrawPrizeItemGL : UIHauteCoutureDrawPrizeItemBase
...
function UIHauteCoutureDrawPrizeItemGL:_OnValue()
    if not self._specail then
        ...
        if uiType == 2 then
            self.bg.sprite = self._atlas:GetSprite("glsenior_zjm_kuang02")
        elseif uiType == 3 then
            self.bg.sprite = self._atlas:GetSprite("glsenior_zjm_kuang01")
        elseif uiType == 4 then
            self.bg.sprite = self._atlas:GetSprite("glsenior_zjm_kuang03")
        end
