...
namespace NFramework.Module.UIModule
{
    public class ViewSubViewComponent : ViewComponent
    {
        ...
        public SubViewRecords ViewRecords
        {
            get
            {
                ...
                {
                    m_viewRecords = GetM<ObjectPoolM>().Alloc<SubViewRecords>();
                    m_viewRecords.Awake();
    ...
    public static class ViewSubViewComponentExtensions
    {
        ...
        public static T AddSubViewSync<T>(this View inParentView, IUIFacadeProvider inProvider) where T : View, new()
        {
            ...
            var view = inParentView.GetM<UIM>().CreateView<T>();
        ...
        public static async Promise<T> AddSubViewASync<T>(this View inParentView, IUIFacadeProvider inProvider)
            where T : View, new()
        {
        ...
        public static async Promise<T> AddSubViewASync<T, D>(this View inParentView, IUIFacadeProvider inProvider,
