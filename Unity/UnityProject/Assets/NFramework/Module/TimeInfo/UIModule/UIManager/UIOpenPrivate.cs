...
namespace NFramework.Module.UIModule
{
    public partial class UIM
    {
        ...
        private WindowRequest CreateRequest<TW, TD>(ViewConfig inViewConfig, TD inViewData)
        ...
        private Promise _OpenAsync<TW, TD>(ViewConfig inViewConfig, TD inViewData)
            where TW : Window, IViewSetData<TD>, new() where TD : class
        {
            if (CheckWindowReq(inViewConfig, out var outWindowRequest))
            {
        ...
        private async void ___AsyncSetFacade(ViewConfig inViewConfig, WindowRequest inWindowRequest,
            Promise.Deferred inDeferred)
        {
