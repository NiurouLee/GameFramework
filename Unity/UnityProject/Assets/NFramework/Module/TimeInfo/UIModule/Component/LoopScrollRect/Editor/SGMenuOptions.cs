...
namespace NFramework.Module.UIModule
{
    static internal class SGMenuOptions
    {
        ...
        [MenuItem("GameObject/UI/WWS_Loop Horizontal Scroll Rect", false, 2151)]
        ...
        [MenuItem("GameObject/UI/WWS_Loop Vertical Scroll Rect", false, 2152)]
        ...
        [MenuItem("GameObject/UI/WWS_Loop Grid Scroll Rect", false, 2152)]
        static public void AddLoopGridScrollRect(MenuCommand menuCommand)
        {
            GameObject go = SGDefaultControls.CreateLoopGridScrollRect(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }
    }
}