...
namespace NFramework.Module.UIModule
{
    public static class SGDefaultControls
    {
        ...
        private static GameObject CreateUIElementRoot
        ...
        {
            GameObject root = CreateUIElementRoot("Loop_Horizontal_Scroll_Rect", new Vector2(200, 200));
        ...
        {
            GameObject root = CreateUIElementRoot("Loop_Grid_Scroll_Rect", new Vector2(200, 200));
        ...
        {
            GameObject root = CreateUIElementRoot("Loop_Vertical_Scroll_Rect", new Vector2(200, 200));
