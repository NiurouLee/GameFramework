...
namespace SG
{
    ...
    [AddComponentMenu("")]
    public class EasyPoolManager : MonoBehaviour
    {
        //obj pool
        private Dictionary<string, Pool> poolDict = new Dictionary<string, Pool>();

        private static EasyPoolManager mInstance = null;

        public static EasyPoolManager Instance
        {
            get
            {
                if (mInstance == null)
                {
                    GameObject go = new GameObject("EasyPoolManager", typeof(EasyPoolManager));
                    ...
                    mInstance = go.GetComponent<EasyPoolManager>();
                    ...
                    {
                        Debug.LogWarning("[EasyPoolManager] You'd better ignore EasyPoolManager in Editor mode");
                    }
                }
        ...
        public void InitPool(string poolName, GameObject prefabGameObject, int size, PoolInflationType type = PoolInflationType.DOUBLE)
        {
            ...
            else
            {
                ...
                if (pb == null)
                {
                    Debug.LogError("[EasyPoolManager] Invalide prefab name for pooling :" + poolName);
                    return;
                }
        ...
        public GameObject GetObjectFromPool(string poolName, GameObject prefab, bool autoActive = true, int autoCreate = 0)
        {
            ...
            {
                InitPool(poolName, prefab, autoCreate, PoolInflationType.INCREMENT);
            }
            ...
            if (poolDict.ContainsKey(poolName))
            {
                ...
                if (result == null)
                {
                    Debug.LogWarning("[EasyPoolManager]:No object available in " + poolName);
                }
#endif
            }
#if UNITY_EDITOR
            ...
            {
                Debug.LogError("[EasyPoolManager]:Invalid pool name specified: " + poolName);
            }
#endif
            return result;
        }
        ...
        public void ReturnTransformToPool(Transform t)
        {
            ...
            {
#if UNITY_EDITOR
                Debug.LogError("[EasyPoolManager] try to return a null transform to pool!");
#endif
                return;
            }
