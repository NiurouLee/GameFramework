...
namespace NFramework.Module.UIModule.ScrollView
{
    ...
    */
    ...
    public class LoopStaggeredGrid : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        System.Func<LoopStaggeredGrid, int,LoopStaggeredGridViewItem> mOnGetItemByDataIndex;
        ...
        */
        public void InitListView(int itemTotalCount, GridViewLayoutParam layoutParam,
            System.Func<LoopStaggeredGrid, int, LoopStaggeredGridViewItem> onGetItemByItemIndex,
            ...
            System.Func<int,(float, float)> onGetItemSizeByItemIndex = null)
        {
            ...
            InitItemPool();
            mOnGetItemByDataIndex = onGetItemByItemIndex;
        ...
        void UpdateItemSize()
        {
            if (mLayoutParam.mItemWidthOrHeight > 0f)
            {
                return;
            }
            ...
            if (IsVertList)
            {
                mLayoutParam.mItemWidthOrHeight = rtf.rect.width;
            }
            else
            {
                mLayoutParam.mItemWidthOrHeight = rtf.rect.height;
            }
            if (mLayoutParam.mItemWidthOrHeight <= 0)
            {
                Debug.LogError("mLayoutParam.mItemWidthOrHeight shoud be > 0");
                return;
            }
        }
        ...
        */
        ...
        public LoopStaggeredGridViewItem GetNewItemByGroupAndIndex(int groupIndex,int indexInGroup)
        {
            ...
            if (count > indexInGroup)
            {
                ...
                newItem = mOnGetItemByDataIndex(this, index);
                if (newItem == null)
                {
                    return null;
                }
