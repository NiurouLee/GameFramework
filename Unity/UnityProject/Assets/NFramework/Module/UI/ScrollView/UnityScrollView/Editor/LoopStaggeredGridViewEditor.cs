...
namespace NFramework.Module.UIModule.ScrollView
{
    ...
    [CustomEditor(typeof(LoopStaggeredGrid))]
    public class LoopStaggeredGridViewEditor : Editor
    {
        ...
        void ShowItemPrefabDataList(LoopStaggeredGrid listView)
        {
        ...
        public override void OnInspectorGUI()
        {
            ...
            LoopStaggeredGrid tListView = serializedObject.targetObject as LoopStaggeredGrid;
            if (tListView == null)
            {
                return;
            }
