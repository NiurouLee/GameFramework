...
namespace NFramework.Module.UIModule
{
    public class EventRecordsComponent : ViewComponent
    {
        ...
        public EventRecords Event
        {
            get
            {
                ...
                {
                    m_viewEventRecords = GetFM<ObjectPoolM>().Alloc<EventRecords>();
        ...
        public override void OnDestroy()
        {
            if (m_viewEventRecords != null)
            {
                ...
                GetFM<ObjectPoolM>().Free(m_viewEventRecords);
    ...
    public static class ViewEventRecordsComponentExtensions
    {
        ...
        {
            var component = ViewComponentUtils.CheckAndAdd<EventRecordsComponent>(inView);
